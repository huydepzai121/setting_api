 ...
 */
/**
 * Ported, byte-for-byte, from `src/templates/cli-posix.sh.tpl`. Do not
 * hand-edit; regenerate from the `.tpl` file (see module header).
 */
const CLI_POSIX_TEMPLATE: string =
...
/**
 * Ported, byte-for-byte, from `src/templates/cli-windows.ps1.tpl`. Do not
 * hand-edit; regenerate from the `.tpl` file (see module header).
 */
const CLI_WINDOWS_TEMPLATE: string =
...
/**
 * Path of the interactive setup CLI route. Returns a shell script that
 * prompts for the same fields the web UI asks for and then calls the two
 * one-line installer routes above with the answers.
 */
export const CLI_SETUP_PATH = "/api/setup/cli";
...
export const ALL_SCRIPT_TEMPLATES: Readonly<Record<string, string>> = {
  ...
  "cli-posix.sh.tpl": CLI_POSIX_TEMPLATE,
  "cli-windows.ps1.tpl": CLI_WINDOWS_TEMPLATE,
};
